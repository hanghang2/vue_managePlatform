<template>
	<div class="zyh-calendar">
		<div class="calendar-head">
			<button v-show="datatype != 2" class="pLeftMonth" @click="prevYear()"> 《 </button>
			<button v-show="datatype === 0" class="pLeftYear" @click="prevMonth()"> < </button>
			<span v-show="datatype != 2" @click="selectyear()">{{year}} 年 </span>
			<span v-show="datatype === 0" @click="selectMonth()"> {{month}} 月</span>
			<button v-show="datatype != 2" class="prightYear" @click="nextYear()"> 》 </button>
			<button v-show="datatype === 0" class="prightMonth" @click="nextMonth()"> > </button>
			<!--年选择-->
